...
public class UserControllerV1 {
    ...
    @ApiOperation(value = "Get all user info", response = User.class, responseContainer = "List")
    @ApiResponses(value = {
        @ApiResponse(code = 404, message = "Successfully retrieved menu items"),
        @ApiResponse(code = 200, message = "No authorization to view menu items")
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 400, message = "Successfully retrieved menu items"),
        @ApiResponse(code = 201, message = "No authorization to view menu items")
    ...
    @ApiResponses(value = {
        @ApiResponse(code = 404, message = "Successfully retrieved menu items"),
        @ApiResponse(code = 400, message = "No authorization to view menu items"),
        @ApiResponse(code = 201, message = "No authorization to view menu items")
